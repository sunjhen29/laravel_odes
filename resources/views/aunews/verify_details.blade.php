...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        {!! Form::model($record,array('role'=>'form','url'=>'/aunews/verify/'.$record->au_news_addresses_id.'/update','action'=>'POST','class'=>'form-horizontal','id'=>'frmNews'))!!}
          <legend>{{ session('batch_details')->job_name.' '.session('batch_details')->batch_date }}</legend>
          
          {!! Form::token() !!}
              
                {!! Form::hidden('status','V') !!}  
