...
<div class="form-group">  
    ...
    <div class="col-md-4 col-sm-3 col-xs-3 custom">
      {!! Form::label('total_floors','Total Building Flrs',['class'=>'control-label custom']) !!}
    </div>
    <div class="col-md-1 col-sm-1 col-xs-2 label">
      {!! Form::text('tennis_court',null,['class'=>'form-control input-sm', 'pattern'=>'[1-9]{1}']) !!}
    </div>
    <div class="col-md-2 col-xs-4 custom">
...
<div class="form-group">  
    <div class="col-md-2 col-md-offset-2 col-sm-2 col-sm-offset-2 col-xs-2 col-xs-offset-1 label">
    ...
    <div class="col-md-2 col-sm-2 col-xs-2 label">
...
<div class="form-group">  
    ...
    <div class="col-md-4 col-md-offset-1 col-sm-2 col-sm-offset-1 col-xs-3 col-xs-offset-2">
...
<div class="form-group">  
    ...
    <div class="col-md-4 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-5 col-xs-offset-2">
...
<div class="form-group">  
    ...
    <div class="col-md-4 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-4 col-xs-offset-3">
