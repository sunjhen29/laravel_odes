...
<div class="row">
  <div class="col-md-10">
    <h3><b>Export Operator Stats</b></h3>
  </div>
  <div class="col-md-2">
    <button type="button" class="btn btn-info btn-md addbutton pull-right" data-toggle="modal" data-target="#myModal1">EXPORT FILE</button>
  </div>
</div>
