...
<div class="row">
  <div class="col-md-10">
    <h3><b>By Publication Report</b></h3>
  </div>
</div>
        ...
        <form class="form-inline">
          ...
          <div class="form-group">
            <label for="publication_date">Publication Date</label>
              <input type="text" class="form-control" id="publication_date1" name="publication_date1" size="13">
              <input type="text" class="form-control" id="publication_date2" name="publication_date2" size="13">
          </div>
