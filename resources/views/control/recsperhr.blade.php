...
<div class="row">
  <div class="col-md-10">
    <h3><b>Records Per Hour Report</b></h3>
  </div>
</div>
        ...
        <form class="form-inline">
          ...
          <div class="form-group">
              <label for="production_date">Production Date</label>
                <input type="text" class="form-control" id="production_date1" name="production_date1" size="13">
                <input type="text" class="form-control" id="production_date2" name="production_date2" size="13">
          </div>
