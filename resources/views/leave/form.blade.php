<div class="panel-body">
      ...
      <div class="form-group">  
        ...
        <div class="col-md-7 custom">
          {!! Form::select('leave_type', $leave_type, null, ['class'=>'form-control aussie_date', 'required']) !!}
        </div>
      </div>
      ...
      <div class="form-group">  
        ...
        <div class="col-md-7 custom">
          {!! Form::text('date_from', null, ['class'=>'form-control aussie_date', 'required']) !!}
        </div>
      </div>
      ...
      <div class="form-group">  
        ...
        <div class="col-md-7 custom">
          {!! Form::text('date_to', null, ['class'=>'form-control date1', 'required']) !!}
        </div>
      </div>
      ...
      <div class="form-group">  
        ...
        <div class="col-md-7 custom">
          {!! Form::text('no_days', null, ['class'=>'form-control', 'required']) !!}
        </div>
      </div>
