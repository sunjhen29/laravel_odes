            ...
            {!! Form::open(array('role'=>'form','class'=>'form-horizontal','name'=>'frmBatch', 'id' => 'frmBatch'))!!}
              ...
              <div class="form-group">
                {!! Form::label('application','Application',['class'=>'control-label col-sm-4']) !!}
                  <div class="col-sm-5">
                    {!! Form::text('application','Australian Newspapers',['class'=>'form-control','required','readonly']) !!}
                  </div>
              </div>
              ...
              <div class="form-group">
                {!! Form::label('job_name','Job Name',['class'=>'control-label col-sm-4']) !!}
                  <div class="col-sm-5">
                    {!! Form::select('job_name', \App\Publication::where('application','Australian Newspapers')->lists('pub_name','pub_name'), null, ['class'=>'form-control','required']) !!}
                  </div>
              </div>
