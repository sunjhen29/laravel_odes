...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
          ...
          {!! Form::open(array('role'=>'form','url'=>'/reanz','action'=>'POST','class'=>'form-horizontal'))!!}
          ...
          <div class="col-md-8">
            {!! Form::select('job_name', \App\Publication::where('application','REA NZ Keying')->lists('pub_name','pub_name'), null, ['class'=>'form-control', 'readonly']) !!}
          </div>  
          </div>
